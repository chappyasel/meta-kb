...
key_insight: >-
  OpenViking's file system paradigm for unified context management (memories,
  resources, skills) with hierarchical L0/L1/L2 loading and automatic session
  compression solves the critical problem of context fragmentation and token
