...
tags:
  ...
  - dspy-integration
key_insight: >-
  GEPA's reflective mutation approach reads full execution traces to diagnose
  failures rather than collapsing them to scalars, enabling efficient
  optimization of any textual parameter (prompts, code, architectures) with 35x
  fewer evaluations than RL methods—critical for builders iterating on knowledge
