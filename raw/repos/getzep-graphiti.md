...
tags:
  ...
  - graphiti
key_insight: >-
  Graphiti's temporal context graphs enable agents to maintain evolving,
  versioned knowledge of facts with explicit validity windows and episode
  provenance—solving the critical problem that standard RAG returns static
