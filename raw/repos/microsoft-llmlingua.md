...
key_insight: >-
  ...
  bottleneck in RAG systems and long-context inference—critical for knowledge
  bases that must scale token budgets across retrieved documents. This is
  particularly valuable for knowledge-base builders using RAG frameworks
  (LangChain, LlamaIndex) since it preserves semantic information while
  dramatically reducing per-query compute overhead.
stars: 5985
forks: 358
relevance_scores:
  topic_relevance: 7
