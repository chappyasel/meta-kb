...
tags:
  ...
  - self-improving
key_insight: >-
  Open Multi-Agent's coordinator-driven auto-decomposition eliminates manual DAG
  definition while enabling parallel task execution—practitioners can abstract
  away orchestration complexity and focus on agent composition, but must
  carefully scope coordinator prompts to avoid over-decomposition of simple
  goals or under-decomposition of complex ones.
stars: 5336
forks: 2177
...
relevance_scores:
  ...
  composite: 7.3
  reason: >-
    Production-ready TypeScript multi-agent orchestration framework with
    coordinator-driven auto-decomposition, parallel DAG execution, shared
    memory, and message bus—directly relevant to multi-agent coordination
    patterns and transferable to agent infrastructure builders.
---
## open-multi-agent
...
**Topics:** agent-framework, ai-agents, anthropic, claude, gemma4, llm, model-agnostic, multi-agent, nodejs, ollama, openai, orchestration, structured-output, task-scheduling, tool-use, typescript
