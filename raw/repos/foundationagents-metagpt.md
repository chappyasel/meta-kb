...
tags:
  ...
  - software-generation
key_insight: >-
  MetaGPT demonstrates that encoding organizational SOPs (standard operating
  procedures) into multi-agent systems enables complex software generation from
  natural language—the key insight is that agent behavior quality scales with
  explicit role definition and orchestrated communication patterns rather than
  monolithic prompting, making it practical to delegate entire engineering
  workflows to agent teams.
stars: 66769
forks: 8453
...
relevance_scores:
  ...
  composite: 7.4
  reason: >-
    MetaGPT is a highly cited, production-ready multi-agent framework that
    encodes SOPs into role-based agent coordination with shared state, directly
    relevant to multi-agent orchestration, task delegation, and agent
    architecture patterns in the knowledge base.
---
## MetaGPT
