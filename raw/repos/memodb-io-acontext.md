...
tags:
  ...
  - portable-agents
key_insight: >-
  Acontext treats agent memory as structured skill files rather than opaque
  vector stores, enabling agents to learn from execution traces through explicit
  distillation while keeping knowledge human-readable, editable, and portable
  across frameworks—this shifts memory from a retrieval problem to a skill
  composition problem.
stars: 3264
forks: 307
relevance_scores:
