...
tags:
  ...
  - Karpathy-pattern
key_insight: >-
  Garry Tan's gstack demonstrates that role-based skill composition (CEO,
  designer, eng manager, QA, security) in Claude Code transforms individual
  shipping velocity by 60% year-over-year—builders need pre-configured agentic
  skill registries, not blank prompts, to unlock AI-assisted development at team
  scale.
stars: 63766
forks: 8626
relevance_scores:
