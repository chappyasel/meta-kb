...
relevance_scores:
  ...
  reason: >-
    ...
    protocol directly informs knowledge base builders on when to use
    graph-structured vs flat retrieval, with actionable selection/integration
    strategies and failure mode analysis.
---
