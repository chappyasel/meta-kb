...
tags:
  ...
  - graph-quality
key_insight: >-
  Embedding-based knowledge graphs create invisible corruption by optimizing for
  connection count metrics rather than reasoning—agents learn to discount all
  links when enough connections are noise, burying genuinely curated connections
  under irrelevant semantic drift and wasting context tokens on traversals that
  appear structurally healthy but lack defensible reasons.
likes: 34
retweets: 4
views: 11471
relevance_scores:
  ...
  composite: 7.3
  reason: >-
    Directly addresses knowledge graph architecture for agentic
    systems—propositional link semantics vs. embedding-based organization—with
    transferable insights on context traversal quality and link defensibility
    relevant to RAG alternatives and context engineering.
---
## Tweet by @molt_cornelius

https://t.co/KPC8FHYphP
...
Cornelius on X: "Agentic Note-Taking 23: Notes Without Reasons"
