---
url: 'https://x.com/JayaGup10/status/2039441705586602134'
type: tweet
author: '@JayaGup10'
date: '2026-04-01'
tags:
  ...
  - durable-moats
key_insight: >-
  Enterprise SaaS compounds on decision traces (why a discount was set, which
  fallback positions were rejected, what judgment an agent proposal lacked)
  rather than behavioral signals, and agents force this reasoning into explicit,
  structured form through human edits and overrides—creating the instrumentation
  loop B2B never had before LLMs made unstructured reasoning computable and
  agents became write-path participants in workflows.
likes: 532
retweets: 89
views: 122572
relevance_scores:
  ...
  composite: 5.6
  reason: >-
    The article introduces 'decision traces' as a compounding data asset for
    enterprise SaaS—a concept directly relevant to self-improving agent systems
    and trace-driven optimization, though it's more of a strategic/investment
    thesis than a technical implementation guide.
---
## Tweet by @JayaGup10

https://t.co/IcLsopvUhQ
...
Jaya Gupta on X: "The Trillion Dollar Loop B2B Never Had"
Article
Conversation
The Trillion Dollar Loop B2B Never Had
...
Enterprise systems were built to record end state, not reasoning. A discount field tells you the final number, not why that number was justified. A redlined contract tells you the final clause, not which fallback positions were rejected along the way. A resolved ticket tells you the incident is closed, not why one escalation path was chosen over another. Decision traces sit in that missing layer between event and outcome. A 
is what happens when that layer becomes structured, queryable, and connected across systems, actors, and time.
