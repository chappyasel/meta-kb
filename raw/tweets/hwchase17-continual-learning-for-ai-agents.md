...
tags:
  ...
  - SOUL.md
key_insight: >-
  Continual learning in agentic systems can happen at three independent
  layers—model weights, harness code/instructions, and context/memory—and the
  context layer often offers the fastest feedback loop for improvement without
  the stability risks of retraining, making it the most practical starting point
  for builders implementing self-improving systems.
relevance_scores:
  topic_relevance: 9
